                        ...
                        <div class="modal fade bd-example-modal" id="menuItems" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="menuItemsForm" method="post" accept-charset="utf-8">
                                        <div class="modal-body">
...
function setEditModal(modal, saleslist, ol, addons, stocks) {
    ...
    ol.forEach(ol => {
        ...
        <tr class="salesElem salesElements" data-id="${ol.olID}" data-stockid="${ol.stID}" data-stqty="${ol.prstQty}"
            ...
            <td><input type="text" id="olDesc" name="olDesc" class="olDesc form-control form-control-sm"
                    value="${ol.olDesc}" readonly="readonly"></td>
            ...
            <td> <select onchange="setSubtotal()" class="discount form-control" style="font-size: 14px;" onchange=""
                    name="discount" id="discount${ol.prID}"></select></td>
            <td><input type="number" name="subtotal" class="subtotal form-control form-control-sm"
                    value="${ol.olSubtotal}" readonly="readonly"></td>
            <td><a class="addAddons btn btn-default btn-sm" style="margin:0;" onclick="addAddons(this);"
                    id="addAddons">Add Addons</a></td>
            </td>
            <td><img class="delBtn" onclick="deleteItem(this)" src="/assets/media/admin/error.png"
        ...
        olAddons.forEach(oa => {
            ...
            <tr class="addonsTable addonsTables" data-id="${oa.olID}">
                ...
                <td>
                    <input type="number" name="aoQty" id="aoQty" onchange="onchangeAddonQuantity(this);"
                        value="${oa.aoQty}" class="aoQty form-control form-control-sm" required min="1">
                </td>
                <td>
                    <input type="number" name="aoPrice" id="aoPrice" value="${oa.aoPrice}"
                        class="aoPrice form-control form-control-sm" readonly>
                </td>
                <td style="text-align:center"> <b> --- </b></td>
                <td>
                    <input type="number" name="aoSubtotal" id="aoSubtotal" value="${oa.aoTotal}"
                        class="aoSubtotal form-control form-control-sm" readonly>
                </td>
                <td style="text-align:center"> <b> --- </b></td>
                <td><img class="delBtn" src="/assets/media/admin/error.png" onclick="deleteItem(this)"
                        style="width:20px;height:20px"></td>
            </tr>`);
