<body style="background:white">
			...
			<div div class="content" style="margin-left:250px;">
				<div class="container-fluid">
					<div class="content">
						<div class="container-fluid">
							<!--Table-->
							<div class="card-content" id="consumptionTable">
								<!--Add  Consumption BUTTON-->
								<div class="col-md-4 col-lg-2">
									<a class="btn btn-primary btn-sm" href="<?= site_url('admin/consumption/formadd') ?>" data-original-title style="margin:0" id="addBtn">Add Consumption</a>
									<!--eND Add  Consumption BUTTON-->
								</div>
							</div>
							<!--eND Add  Consumption BUTTON-->
							<!--Search-->
							<div id="consumptionTable" style="width:25%; float:right; border-radius:5px">
							...
							<table id="consumptionTable" class="spoiltable table table-bordered dt-responsive nowrap" cellpadding="0" width="100%">
								...
								<tbody id="spoilage_data" class="consumptionTable ic-level-2">
								</tbody>
							</table>
							<!--End Table Content-->
	...
	<script>
		...
		function setConsumptionData() {
			...
			<tr class="consumptionTabletr ic-level-1" data-tiActual="${table.tiActual}" data-tiQty="${table.tiQty}" data-stQty="${table.stQty}" data-tiRemarks="${table.tiRemarks}" data-tiDate="${table.tiDate}" data-stID="${table.stID}" data-ciID="${table.ciID}">
		...
		//Search Function
		$("#consumptionTable input[name='search']").on("keyup", function() {
			var string = $(this).val().toLowerCase();

			$("#consumptionTable .ic-level-1").each(function(index) {
