                                ...
                                <form id="drForm" action="<?= site_url("admin/deliveryreceipt/add")?>"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <textarea type="text" name="remarks" class="form-control form-control-sm"
                                                rows="1"></textarea>
                                        </div>
                                        ...
                                        <div class="form-check form-check-inline mb-3"
                                            ...
                                            <label class="form-check-label mr-3"><input class="form-check-input"
                                                    type="radio" name="inlineRadioOptions">PO-based</label>
                                            <label class="form-check-label mr-3"><input class="form-check-input"
                                                    type="radio" name="inlineRadioOptions">Non-PO based</label>
                                            <label class="form-check-label mr-3"><input class="form-check-input"
                                                    type="radio" name="inlineRadioOptions">No Supplier</label>
                                        </div>
                                        <!--Buttons-->
                                        <button id="addNewBtn" class="btn btn-outline-primary btn-sm m-0"
                                            type="button">New Item</button>
                                        <button id="addMBtn" class="btn btn-outline-primary btn-sm m-0"
                                            type="button">Add Merchandise</button>
                                        <button id="addPOBtn" class="btn btn-outline-primary btn-sm m-0"
                                            type="button">PO Item</button>
                                        <button id="addRBtn" class="btn btn-outline-primary btn-sm m-0"
