                    ...
                    <div class="content">
                        <div class="container-fluid">
                            ...
                            <div class="card-content">
                                <a class="btn btn-primary btn-sm" href="<?= site_url('admin/officialreceipt/formadd')?>" data-original-title style="margin:0"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add Official Receipt</h5>
                                            ...
                                            <form accept-charset="utf-8">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <a id="addDRBtn" class="btn btn-primary btn-sm" data-toggle="modal"
                                                        ...
                                                        style="color:white;font-weight:600;background:#0073e6">DR Item</a>
                                                    <br><br>
