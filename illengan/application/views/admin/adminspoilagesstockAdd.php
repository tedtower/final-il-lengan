<body style="background: white">
                        ...
                        <div class="card" style="float:left;width:60%">
                            ...
                            <form id="conForm" action="<?= site_url("admin/stock/spoilages/add")?>" accept-charset="utf-8"
                                ...
                                <div class="card-body">
									...
									<input name="uomID" id="uomID" hidden="hidden">
    ...
    $(function() {
        ...
        $("#stockCard input[name='stock']").on("click", function(event) {
            // ----
            var curQtydata = $(this).attr("data-curQty");
            var uomIDdata = $(this).attr("data-uomID");
            //----
            var id = $(this).val();
        ...
        $("#card").find("input[name='curQty']").val(curQtydata);
        $("#card").find("input[name='uomID']").val(uomIDdata); 
