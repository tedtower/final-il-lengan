                ...
                <!--Start of Modal "Restock Item"-->
                    ...
                    <div class="modal fade bd-example-modal-lg" id="addEditStock" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add/Edit Stock Item</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="<?php echo base_url('admin/inventory/addEdit')?>" method="post"
                                    ...
                                    <div class="modal-body" style="margin:1%;">
                                        ...
                                        <h6>Original Unit of Stock Item</h6>
                                        <div class="form-row">
                                            <!--Stock Type-->
                                        ...
                                        <h6>Minimum and Starting Quantity</h6>
                                        <div class="form-row">
                                            <!--Min Quantity-->
                                            <div class="input-group mb-3 col">
                                                <div class="input-group-prepend">
