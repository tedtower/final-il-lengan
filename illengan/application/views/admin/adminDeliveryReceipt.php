	...
	function createPagination(pageNum){
		...
		function setDelReceiptsData(del, delItems) {
            ...
            var accordion = `<tr class="accordion" style="display:none;background: #f9f9f9">`;
                ...
                for(it in dri){
                accordion +=`<tr>`;
                accordion +=` <td>${dri[it].stockname}</td>`;
                ...
                if(dri[it].tiDiscount == null){
                    if(isNaN((dri[it].qty * dri[it].spmPrice))){
                        accordion +=` <td>N/A</td>`;
                    }else{
                        accordion +=`<td>${(dri[it].qty * dri[it].spmPrice)}</td>`;
                    }
                }else{
                    if(isNaN((dri[it].qty * dri[it].spmPrice) - parseInt(dri[it].tiDiscount))){
                        accordion +=` <td>N/A</td>`;
                    }else{
                        accordion +=`<td>${(dri[it].qty * dri[it].spmPrice) - parseInt(dri[it].tiDiscount)}</td>`;
                    }
                }
                accordion +=` <td>${dri[it].piStatus}</td>`;
                accordion +=`</tr>`;
                accordion +=` </tbody>
                                </table>`;
                }
