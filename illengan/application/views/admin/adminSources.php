...
<body style="background:white">
            ...
            <div class="content" style="margin-left:250px;">
                <div class="container-fluid">
                    <div class="content">
                        <div class="container-fluid">
                            <!--Table-->
                            <div class="card-content" id="supplierTable">
                                ...
                                <!--Search-->
                                <div id="supplierTable" style="width:25%; float:right; border-radius:5px">
                                ...
                                <table id="suppliertable" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody class="supplierTable ic-level-1">
                                    </tbody>
                                </table>
                                <p id="note"></p>
                                <!--End Table Content-->
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="input-group mb-3 col">
                                                            ...
                                                            <input class="form-control form-control-sm" name="email" type="textarea" placeholder="(opitonal)" id="email" require pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" require title="You have entered an invalid E-mail address. Please try again.">
                                                        </div>
                                                        <!--Status-->
                                                        <div class="input-group mb-3 col">
                                                            <div class="input-group-prepend">
    ...
    `;
        ...
        //Search Function
		$("#supplierTable input[name='search']").on("keyup", function() {
			var string = $(this).val().toLowerCase();

			$("#supplierTable .ic-level-1").each(function(index) {
