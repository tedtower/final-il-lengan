                        ...
                        <form action="<?php echo base_url()?>admin/addon/add" method="post" accept-charset="utf-8">
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="aoName" class="form-control form-control-sm" required>
                                </div>
                                <!--Price-->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="number" name="aoPrice" class="form-control form-control-sm" required>
                                </div>   
                                <!--Category-->                                                                                 
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <form action="<?php echo base_url()?>admin/addon/edit" method="post" accept-charset="utf-8">
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="aoName" id="aoName" class="form-control form-control-sm" required>
                                </div>
                                <!--Price-->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="number" name="aoPrice" id="aoPrice" class="form-control form-control-sm" required>
                                </div>   
                                <!--Category-->                                                                                 
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
