            ...
            <div class="content" style="margin-left:250px;">
                <div class="container-fluid">
                    ...
                    <div class="card-content" id="menuTable">
                        <button id="addPromo" class="btn btn-primary btn-sm" onclick="addItemOptions();removeOptions()" data-toggle="modal" data-target="#newPromo" data-original-title style="margin:0">Add Promo</button>
                        <br>
                        <!--Search-->
                        ...
                        <table id="menuTable" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody class="menuTable ic-level-1">

                            </tbody>
                        </table>
                        <!--Start of Modal "Add Menu"-->
                        <div class="modal fade bd-example-modal-lg" aria-labelledby="exampleModalLabel" aria-hidden="true" id="newPromo" tabindex="-1" role="dialog" style="overflow: auto !important;">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo base_url() ?>admin/promo/add" method="get" accept-charset="utf-8" id="addNewPromo">
                                        <div class="modal-body">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><select class="form-control promoOpt" name="dc_item" id="dc_item" required>
                                                            </select></td>
                                                        <td>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="submitPromo" onclick="addPromos()" class="btn btn-success btn-sm" type="button">Insert</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="modal fade bd-example-modal" style="background:rgba(0, 0, 0, 0.3)" id="addSubFreebie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form id="formAdd" action="<?= site_url('admin/purchaseorder/add') ?>" method="post" accept-charset="utf-8">
                                        <div class="modal-body">
                                            ...
                                            <table id="subAddFreebie" class="table table-lg table-borderless">
                                                ...
                                                <tbody id="tbFb">
                                                    <tr id="trFb">
                                                        <td><select class="form-control promoOpt menuName" name="menu_name" id="menu_name"></select></td>
                                                        <td><input type="number" name="pcQty" id="pcQty" min="0" class="form-control form-control-sm"></td>
                                                        <td><select class="form-control promoOpt fbItem" name="fb_item" id="fb_item"></select></td>
    ...
    <script>
        ...
        function showTable() {
            promos.forEach(function(item) {
                var tableRow = `                
                <tr class="table_row ic-level-1" data-id="${item.promos.pmID}">   <!-- table row ng table -->
