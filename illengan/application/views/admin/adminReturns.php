                                ...
                                <table id="transTable" class="table table-bordered dt-responsive nowrap" cellspacing="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <button class="editBtn btn btn-sm btn-secondary" data-toggle="modal" data-target="#editReturn" >Edit</button>
                                                <button class="deleteBtn btn btn-sm btn-warning" data-toggle="modal" data-target="#deleteReturn">Archive</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="6">
