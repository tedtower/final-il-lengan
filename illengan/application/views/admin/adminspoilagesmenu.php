<body style="background:white">
						...
						<div class="container-fluid">
							...
							<div class="card-content" id="menuTable">
								...
								<table id="menuTable" class="spoiltable table table-bordered dt-responsive nowrap" cellpadding="0" width="100%">
									...
									<tbody id="menu_data" class="menuTable ic-level-1">
									</tbody>
								</table>
								<!--End Table Content-->
								...
								<div class="modal fade bd-example-modal" id="brochureSS" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background:rgba(0, 0, 0, 0.3)">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="exampleModalLabel">Select Menu Item</h5>
												<button type="button" class="close" data-dismiss="modal" aria-label="Close">
													<span aria-hidden="true">&times;</span>
												</button>
											</div>
	...
	<script>
		...
		function setSpoilagesData() {
            ...
            <tr class="menuTable ic-level-1" data-prID="${table.prID}" data-msID="${table.msID}" data-msQty="${table.msQty}" data-msDate="${table.msDate}" data-msRemarks="${table.msRemarks}" >
