                                ...
                                <div class="modal fade bd-example-modal-lg" id="newMenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="overflow: auto !important;">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo base_url() ?>admin/menu/add" method="post" accept-charset="utf-8">
                                                <div class="modal-body">
                                                    ...
                                                    <!--Menu Items-->
                                                    <a class="addPreference btn btn-primary btn-sm" style="color:blue;margin:0">Add Preferences</a>
                                                    <!--Button to add row in the table-->
                                                    <br><br>
                                                    <table class="preferencetable table table-sm table-borderless">
                                                    ...
                                                    <!--Menu Items-->
                                                    <a class="addAddon btn btn-primary btn-sm" style="color:blue;margin:0">Add Addons</a>
                                                    <!--Button to add row in the table-->
                                                    <br><br>
                                                    <table class="addontable table table-sm table-borderless">
                                                        <!--Table containing the different input fields in adding trans items -->
                                                        <thead class="thead-light">
                                                            <tr>
                                ...
                                <div class="modal fade bd-example-modal-lg" id="editMenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="overflow: auto !important;">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo base_url() ?>admin/menu/edit" method="post" accept-charset="utf-8">
                                                <div class="modal-body">
