      ...
      <ul class="navbar-nav mr-auto delius">
          ...
          <li class="nav-item dropdown mr-2">
              ...
              <div class="dropdown-menu dropdown-default elegant-color c-focus" aria-labelledby="menu-dd">
                  <a class="dropdown-item" href="<?php echo base_url('barista/addDeliveryReceipt')?>"><i class="far fa-truck-loading"></i> Delivery Receipt</a>
          ...
          <li class="nav-item dropdown mr-2">
              ...
              <div class="dropdown-menu dropdown-default elegant-color c-focus">
                  ...
                  <a class="dropdown-item" href="<?php echo base_url('barista/addons/spoilages')?>"><i class="fal fa-utensils-alt"></i> Addons Spoilage</a>
