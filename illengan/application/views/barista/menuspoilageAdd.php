            ...
            <br>
                <div class="container-fluid">
                    ...
                    <div style="overflow:auto">
                        ...
                        <a  class="btn btn-primary btn-sm" href="<?= site_url('barista/spoilages/menu')?>" data-original-title style="margin:0;width:20%"
                    ...
                    <div style="overflow:auto">
                        ...
                        <div class="card" style="float:left;width:60%">
                            ...
                            <form id="conForm" action="<?= site_url("barista/menuspoilage/add")?>" accept-charset="utf-8"
                                class="form">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div>
                                        <a href="<?= site_url('barista/spoilages/menu')?>"><button type="button" class="btn btn-danger btn-sm"
