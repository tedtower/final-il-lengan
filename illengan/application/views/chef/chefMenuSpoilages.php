...
<div class="content">
	<div class="container-fluid" style="margin-top: 70px;">
		<br>
		<p style="text-align:right; font-weight: regular; font-size: 16px;margin-right: 3%;">
			<!-- Real Time Date & Time -->
...
<script src="<?= chef_js().'addMenuSpoilBrochure.js'?>"></script>
<script>
	var spoilages = [];
	var menuchoice = [];
	$(function() {
